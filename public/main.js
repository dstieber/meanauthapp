...
module.exports = "<nav class=\"navbar navbar-expand-md navbar-dark bg-dark\">\n    <a class=\"navbar-brand\" href=\"#\">MEAN Auth App</a>\n\n    <div class=\"collapse navbar-collapse\">\n      <ul class=\"navbar-nav mr-auto\">\n        <li><a class=\"nav-link\" routerLink=\"/\" routerLinkActive=\"active\" [routerLinkActiveOptions]=\"{ exact: true }\">Home</a></li>\n      </ul>\n      <ul class=\"navbar-nav mr-sm-2\">\n          <li *ngIf=\"authService.loggedIn()\" ><a class=\"nav-link\" routerLink=\"/login\" routerLinkActive=\"active\">Login</a></li>\n          <li *ngIf=\"authService.loggedIn()\" ><a class=\"nav-link\" routerLink=\"/register\" routerLinkActive=\"active\">Register</a></li>\n          <li *ngIf=\"!authService.loggedIn()\" ><a class=\"nav-link\" routerLink=\"/dashboard\" routerLinkActive=\"active\">Dashboard</a></li>\n          <li *ngIf=\"!authService.loggedIn()\" ><a class=\"nav-link\" routerLink=\"/profile\" routerLinkActive=\"active\">Profile</a></li>\n          <li *ngIf=\"!authService.loggedIn()\" ><a class=\"nav-link\" (click)=\"onLogoutClick()\" href=\"#\">Logout</a></li>\n      </ul>\n    </div>\n  </nav>\n"
...
var NavbarComponent = /** @class */ (function () {
    function NavbarComponent(authService, ngFlashMessageService, router) {
        this.authService = authService;
        this.ngFlashMessageService = ngFlashMessageService;
        this.router = router;
    }
...
var ProfileComponent = /** @class */ (function () {
    ...
    ProfileComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.authService.getProfile(this.user).subscribe(function (profile) {
...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.getProfile = function (user) {
        var headers = new _angular_http__WEBPACK_IMPORTED_MODULE_1__["Headers"]();
        this.loadToken();
...
module.exports = __webpack_require__(/*! /Users/Danimals/Programming/Web Dev/angular/meanauthapp/angular-src/src/main.ts */"./src/main.ts");
